...
func runRouterMain() {
	...
	authGroup.Use(middlerware.JWTAuth())
	{
		...
		authGroup.POST("/api/tools/v1/toolsmanage", api.CudToolsmanage)
		authGroup.GET("/api/tools/v1/toolsrun", api.ToolsRun)
		authGroup.GET("/api/tools/v1/toolsmanage", api.GetToolsmanage)
		authGroup.GET("/api/tools/v1/toolsmanagebyid", api.GetToolsmanageById)
